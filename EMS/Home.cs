        ...
        public Home()
        {
            ...
            LoadYears();
                ...
                try
                {
                    ...
                    using (MySqlConnection connection = new MySqlConnection(connectionString))
                    {
                        ...
                        string yearQuery = "SELECT COUNT(*) FROM students_tbl";
            ...
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string yearQuery = "SELECT COUNT(*) FROM user_tbl";
            ...
            try
            {
                using (var connection = new MySqlConnection("server=localhost;database=ems;uid=admin;pwd=admin;"))
                {
                    ...
                    string loginQuery = $@"SELECT full_name
                    FROM user_tbl
        ...
        private void LoadData()
        {
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string expenseQuery = @"SELECT studentid AS 'ID', fname AS 'First Name', lname AS 'Last Name', year AS 'Year', section AS 'Section', contactnum AS 'Contact Number', course AS 'Course', studentnum AS 'Student Number', username AS 'Registrar' FROM students_tbl WHERE registration_date > DATE_SUB(NOW(), INTERVAL 1 DAY) ORDER BY registration_date DESC";
